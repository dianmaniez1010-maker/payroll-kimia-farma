        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-2">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <nav class="hidden md:flex items-center gap-6 lg:gap-8 text-sm font-semibold uppercase tracking-wide">
                    <a href="#beranda" class="nav-link hover:text-kf-blue transition text-slate-700">Beranda</a>
                    <a href="fitur" class="nav-link hover:text-kf-blue transition text-slate-700">Fitur</a>
                    <a href="modul" class="nav-link hover:text-kf-blue transition text-slate-700">Modul</a>
                    <a href="keunggulan" class="nav-link hover:text-kf-blue transition text-slate-700">Keunggulan</a>
                    <a href="tentang" class="nav-link hover:text-kf-blue transition text-slate-700">Tentang</a>
                    <a href="kontak" class="nav-link hover:text-kf-blue transition text-slate-700">Kontak</a>
                </nav>
            ...
            <div id="mobile-menu" class="hidden md:hidden border-t border-slate-100 mt-3 pt-3 pb-2 space-y-2 text-sm font-semibold uppercase text-slate-700">
                <a href="#beranda" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg bg-blue-50 text-kf-navy font-bold">Beranda</a>
                <a href="fitur" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg hover:bg-slate-50 transition">Fitur</a>
                <a href="modul" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg hover:bg-slate-50 transition">Modul</a>
                <a href="keunggulan" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg hover:bg-slate-50 transition">Keunggulan</a>
                <a href="tentang" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg hover:bg-slate-50 transition">Tentang</a>
                <a href="kontak" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg hover:bg-slate-50 transition">Kontak</a>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs">
                    <li><a href="#fitur" class="hover:text-white transition">Feature</a></li>
                    <li><a href="#modul" class="hover:text-white transition">Module</a></li>
                    <li><a href="#keunggulan" class="hover:text-white transition">Superiority</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs">
                    <li><a href="#tentang" class="hover:text-white transition">About Us</a></li>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function changeActiveNav() {
                ...
                navLinks.forEach(link => {
                    link.classList.remove('text-kf-navy', 'border-b-2', 'border-kf-navy');
                    link.classList.add('text-slate-700');
                    
                    if (link.getAttribute('href') === `#${current}`) {
                        link.classList.add('text-kf-navy', 'border-b-2', 'border-kf-navy');
