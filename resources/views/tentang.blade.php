...
<head>
    ...
    <title>Tentang Kami - Payroll & HRIS Kimia Farma</title>
...
<body class="bg-white text-slate-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-2">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <nav class="hidden md:flex items-center gap-6 lg:gap-8 text-sm font-semibold uppercase tracking-wide">
                    ...
                    <a href="{{ url('/modul') }}" class="hover:text-kf-blue transition text-slate-700">Modul</a>
                    <a href="{{ url('/') }}#keunggulan" class="hover:text-kf-blue transition text-slate-700">Keunggulan</a>
                    <a href="{{ url('/tentang') }}" class="text-kf-navy border-b-2 border-kf-navy transition">Tentang</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden border-t border-slate-100 mt-3 pt-3 pb-2 space-y-2 text-sm font-semibold uppercase text-slate-700">
                ...
                <a href="{{ url('/tentang') }}" onclick="toggleMobileMenu()" class="block px-3 py-2 rounded-lg bg-blue-50 text-kf-navy font-bold">Tentang</a>
    ...
    <main class="max-w-4xl mx-auto py-12 px-6 text-center">
        <span class="text-xs font-bold text-kf-cyan bg-blue-50 px-3 py-1 rounded-full uppercase border border-blue-200">Tentang Aplikasi</span>
        <h2 class="text-3xl font-extrabold text-slate-900 mt-4 mb-6">Sistem Informasi HRIS & Payroll Kimia Farma</h2>
        
        <p class="text-sm text-slate-600 leading-relaxed mb-6">
            Platform Payroll & HRIS ini merupakan sistem transformasi digital internal yang dirancang untuk mendukung tata kelola administrasi kepegawaian dan kompensasi di lingkungan <strong>PT Kimia Farma Tbk</strong> beserta seluruh anak perusahaannya.
        </p>

        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div class="bg-white p-4 rounded-xl border border-slate-200">
                <div class="text-2xl font-black text-kf-navy">3,400+</div>
                <div class="text-[11px] text-slate-500 mt-1">Total Karyawan</div>
            </div>
            <div class="bg-white p-4 rounded-xl border border-slate-200">
                <div class="text-2xl font-black text-kf-navy">100%</div>
                <div class="text-[11px] text-slate-500 mt-1">Akurasi Pajak & BPJS</div>
            </div>
            <div class="bg-white p-4 rounded-xl border border-slate-200">
                <div class="text-2xl font-black text-kf-navy">Multi-Unit</div>
                <div class="text-[11px] text-slate-500 mt-1">Apotek, Plant & R&D</div>
            </div>
            <div class="bg-white p-4 rounded-xl border border-slate-200">
                <div class="text-2xl font-black text-kf-navy">ISO 27001</div>
                <div class="text-[11px] text-slate-500 mt-1">Standar Keamanan</div>
            </div>
        </div>
    </main>
